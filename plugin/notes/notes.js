...
!(function (t, e) {
    "object" == typeof exports && "undefined" != typeof module ? (module.exports = e()) : "function" == typeof define && define.amd ? define(e) : ((t = t || self).RevealNotes = e());
})(this, function () {
    "use strict";
    ...
    var $,
        ...
        U = Math.random(),
        Z = function (t) {
            return "Symbol(" + String(void 0 === t ? "" : t) + ")_" + (++D + U).toString(36);
        },
        W = q("keys"),
        K = {},
        J = r.WeakMap;
    ...
    var G = {
        ...
        X = e(function (t) {
            ...
            (t.exports = function (t, e, a, o) {
                var l = !!o && !!o.unsafe,
                    s = !!o && !!o.enumerable,
                    c = !!o && !!o.noTargetGet;
                "function" == typeof a && ("string" != typeof e || k(a, "name") || z(a, "name", e), (n(a).source = i.join("string" == typeof e ? e : ""))),
        ...
        dt = pt.indexOf,
        ft = ["constructor", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "toLocaleString", "toString", "valueOf"].concat("length", "prototype"),
        ht = {
            f:
        ...
        _t = function (t, e) {
            ...
            if ((n = c ? r : u ? r[s] || R(s, {}) : (r[s] || {}).prototype))
                for (i in e) {
                    if (((o = e[i]), (a = t.noTargetGet ? (l = Tt(n, i)) && l.value : n[i]), !Et(c ? i : s + (u ? "." : "#") + i, t.forced) && void 0 !== a)) {
    ...
    ($t = function (t) {
        ...
        return (
            ...
            a.lastIndex > 0 && (!a.multiline || (a.multiline && "\n" !== t[a.lastIndex - 1])) && ((s = "(?: " + s + ")"), (u = " " + u), c++),
                (n = new RegExp("^(?:" + s + ")", l))),
            Pt && (n = new RegExp("^" + s + "$(?!\\s)", l)),
            Ct && (e = a.lastIndex),
                (r = Ot.call(o ? n : a, u)),
                o ? (r ? ((r.input = r.input.slice(c)), (r[0] = r[0].slice(c)), (r.index = a.lastIndex), (a.lastIndex += r[0].length)) : (a.lastIndex = 0)) : Ct && r && (a.lastIndex = a.global ? r.index + r[0].length : e),
            Pt &&
            r &&
            r.length > 1 &&
    ...
    var jt =
        ...
        qt = q("wks"),
        Dt = r.Symbol,
        Ut = Nt ? Dt : (Dt && Dt.withoutSetter) || Z,
        Zt = function (t) {
            return k(qt, t) || (jt && k(Dt, t) ? (qt[t] = Dt[t]) : (qt[t] = Ut("Symbol." + t))), qt[t];
        },
        Wt = Zt("species"),
        Kt = !i(function () {
            var t = /./;
            ...
            if (!o || !l || ("replace" === t && (!Kt || !Jt || Ht)) || ("split" === t && !Bt)) {
                var s = /./[a],
                    c = n(
                        ...
                        ""[t],
                        function (t, e, n, r, i) {
                            return e.exec === Mt ? (o && !i ? { done: !0, value: s.call(e, n, r) } : { done: !0, value: t.call(n, e, r) }) : { done: !1 };
                        },
        ...
        return [
            ...
            function (t, r) {
                ...
                for (var m, v = "", y = 0, k = 0; k < h.length; k++) {
                    g = h[k];
                    for (var b = String(g[0]), w = ke(be(it(g.index), u.length), 0), x = [], S = 1; S < g.length; S++) x.push(void 0 === (m = g[S]) ? m : String(m));
                    var E = g.groups;
                    if (p) {
    ...
    _t(
        ...
        {
            link: function (t) {
                return (e = "a"), (n = "href"), (r = t), (i = String(h(this))), (a = "<" + e), "" !== n && (a += " " + n + '="' + String(r).replace(Te, "&quot;") + '"'), a + ">" + i + "</" + e + ">";
                var e, n, r, i, a;
            },
        }
    );
    ...
    var qe,
        ...
        Ke = function (t, e) {
            var n;
            return Ze(t) && ("function" != typeof (n = t.constructor) || (n !== Array && !Ze(n.prototype)) ? m(n) && null === (n = n[We]) && (n = void 0) : (n = void 0)), new (void 0 === n ? Array : n)(0 === e ? 0 : e);
        },
        Je = [].push,
        Fe = function (t) {
            var e = 1 == t,
        ...
        Ve = Ye && Ye.versions,
        Ge = Ve && Ve.v8;
    Ge ? (De = (qe = Ge.split("."))[0] + qe[1]) : Be && (!(qe = Be.match(/Edge\/(\d+)/)) || qe[1] >= 74) && (qe = Be.match(/Chrome\/(\d+)/)) && (De = qe[1]);
    var Xe = De && +De,
        Qe = Zt("species"),
        tn = function (t) {
            return (
        ...
        { target: "Array", proto: !0, forced: !on || !ln },
        {
            slice: function (t, e) {
                var n,
                    ...
                    l = ct(t, o),
                    s = ct(void 0 === e ? o : e, o);
                if (Ze(a) && ("function" != typeof (n = a.constructor) || (n !== Array && !Ze(n.prototype)) ? m(n) && null === (n = n[sn]) && (n = void 0) : (n = void 0), n === Array || void 0 === n)) return cn.call(a, l, s);
    ...
    if (
        ...
        for (
            var Tn = function (t, e) {
                    ...
                    Sn ? i && !a && (t = t.source) : t instanceof Tn && (a && (e = At.call(t)), (t = t.source)), En && (n = !!e && e.indexOf("y") > -1) && (e = e.replace(/y/g, ""));
                    var o,
                        l,
                        s,
                        c,
                        u,
                        p = ((o = Sn ? new kn(t, e) : kn(t, e)), (l = r ? this : bn), (s = Tn), pn && "function" == typeof (c = l.constructor) && c !== s && m((u = c.prototype)) && u !== s.prototype && pn(o, u), o);
    ...
    var Rn,
        ...
        Mn = $n("endsWith");
    _t(
        { target: "String", proto: !0, forced: !!(Mn || ((Rn = Cn(String.prototype, "endsWith")), !Rn || Rn.writable)) && !Mn },
        {
            endsWith: function (t) {
                var e = String(h(this));
                On(t);
                ...
                (r =
                    "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length
                        ? function (t, n) {
                            ...
                            for (
                                var a, o, l, s = [], c = (t.ignoreCase ? "i" : "") + (t.multiline ? "m" : "") + (t.unicode ? "u" : "") + (t.sticky ? "y" : ""), u = 0, p = new RegExp(t.source, c + "g");
                                (a = Mt.call(p, r)) && !((o = p.lastIndex) > u && (s.push(r.slice(u, a.index)), a.length > 1 && a.index < r.length && Nn.apply(s, a.slice(1)), (l = a[0].length), (u = o), s.length >= i));

                            )
                                p.lastIndex === a.index && p.lastIndex++;
                            return u === r.length ? (!l && p.test("")) || s.push("") : s.push(r.slice(u)), s.length > i ? s.slice(0, i) : s;
                        }
                        ...
                        function (t, i) {
                            ...
                            var o = T(t),
                                ...
                                s = (function (t, e) {
                                    var n,
                                        r = T(t).constructor;
                                    return void 0 === r || null == (n = T(r)[jn]) ? e : Ue(n);
                                })(o, RegExp),
                                c = o.unicode,
                                u = (o.ignoreCase ? "i" : "") + (o.multiline ? "m" : "") + (o.unicode ? "u" : "") + (Dn ? "y" : "g"),
                                p = new s(Dn ? o : "^(?:" + o.source + ")", u),
                            ...
                            for (var f = 0, h = 0, g = []; h < l.length; ) {
                                p.lastIndex = Dn ? h : 0;
                                var m,
                                    v = Qt(p, Dn ? l : l.slice(h));
                                if (null === v || (m = qn(ot(p.lastIndex + (Dn ? 0 : h)), l.length)) === f) h = Xt(l, h, c);
                                else {
    ...
    _t(
        {
            ...
            forced:
                !(
                    !Kn &&
                    !!(function () {
                        var t = Un(String.prototype, "startsWith");
                        return t && !t.writable;
                    })()
                ) && !Kn,
        },
    ...
    var nr = e(function (t) {
        ...
        rr = (nr.defaults, nr.getDefaults, nr.changeDefaults, tn("splice")),
        ...
        { target: "Array", proto: !0, forced: !rr || !ir },
        {
            splice: function (t, e) {
                var n,
                    ...
                    u = ct(t, c),
                    p = arguments.length;
                if ((0 === p ? (n = r = 0) : 1 === p ? ((n = 0), (r = c - u)) : ((n = p - 2), (r = or(ar(it(e), 0), c - u))), c + n - r > 9007199254740991)) throw TypeError("Maximum allowed length exceeded");
    ...
    function xr(t, e) {
        ...
        return "//" === e.substring(0, 2) ? (n ? e : t.replace(br, "$1") + e) : "/" === e.charAt(0) ? (n ? e : t.replace(wr, "$1") + e) : t + e;
    }
    function Sr(t, e, n) {
        var r = t.length;
        if (0 === r) return "";
    ...
    function qr(t, e, n) {
        ...
        return "!" !== t[0].charAt(0) ? { type: "link", raw: n, href: r, title: i, text: t[1] } : { type: "image", raw: n, text: jr(t[1]), href: r, title: i };
    }
    var Dr = (function () {
            function t(e) {
                ...
                fe(t, [
                    ...
                    },
                    {
                        ...
                        value: function (t, e) {
                            ...
                            if (n) {
                                ...
                                return { type: "code", raw: n[0], codeBlockStyle: "indented", text: this.options.pedantic ? i : Pr(i, "\n") };
                            }
                        },
                    },
                    {
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            if (e) {
                                var n = { type: "table", header: Mr(e[1].replace(/^ *| *\| *$/g, "")), align: e[2].replace(/^ *|\| *$/g, "").split(/ *\| */), cells: e[3] ? e[3].replace(/\n$/, "").split("\n") : [], raw: e[0] };
                        ...
                        value: function (t) {
                            ...
                            if (e) {
                                for (
                                    ...
                                    (u.length > 1 ? 1 === i.length : i.length > 1 || (this.options.smartLists && i !== u)) && ((a = f.slice(m + 1).join("\n")), (d.raw = d.raw.substring(0, d.raw.length - a.length)), (m = g - 1))),
                                        (o = h || /\n\n(?!\s*$)/.test(n)),
                        ...
                        value: function (t) {
                            ...
                            if (e) {
                                ...
                                if (n.header.length === n.align.length) {
                                    ...
                                    for (r = 0; r < i; r++)
                                        /^ *-+: *$/.test(n.align[r]) ? (n.align[r] = "right") : /^ *:-+: *$/.test(n.align[r]) ? (n.align[r] = "center") : /^ *:-+ *$/.test(n.align[r]) ? (n.align[r] = "left") : (n.align[r] = null);
                                    for (i = n.cells.length, r = 0; r < i; r++) n.cells[r] = Mr(n.cells[r].replace(/^ *\| *| *\| *$/g, ""), n.header.length);
                                    return n;
                                }
                            }
                        },
                            ...
                            if (r)
                                return (
                                    !e && /^<a /i.test(r[0]) ? (e = !0) : e && /^<\/a>/i.test(r[0]) && (e = !1),
                                        ...
                                        { type: this.options.sanitize ? "text" : "html", raw: r[0], inLink: e, inRawBlock: n, text: this.options.sanitize ? (this.options.sanitizer ? this.options.sanitizer(r[0]) : jr(r[0])) : r[0] }
                                );
                        },
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            if (e) {
                                ...
                                return qr(e, { href: (i = i.trim().replace(/^<([\s\S]*)>$/, "$1")) ? i.replace(this.rules.inline._escapes, "$1") : i, title: a ? a.replace(this.rules.inline._escapes, "$1") : a }, e[0]);
                            }
                        },
                    },
                    {
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            if (e) {
                                ...
                                return r && i && (n = n.substring(1, n.length - 1)), (n = jr(n, !0)), { type: "codespan", raw: e[0], text: n };
                            }
                        },
                    },
                    {
                    ...
                    },
                    {
                        ...
                        value: function (t, e) {
                            ...
                            if (i) return (r = "@" === i[2] ? "mailto:" + (n = jr(this.options.mangle ? e(i[1]) : i[1])) : (n = jr(i[1]))), { type: "link", raw: i[0], text: n, href: r, tokens: [{ type: "text", raw: n, text: n }] };
                        },
                    },
                    {
                        key: "url",
                    ...
                    },
                    {
                        ...
                        value: function (t, e, n) {
                            ...
                            if (i) return (r = e ? (this.options.sanitize ? (this.options.sanitizer ? this.options.sanitizer(i[0]) : jr(i[0])) : i[0]) : jr(this.options.smartypants ? n(i[0]) : i[0])), { type: "text", raw: i[0], text: r };
                        },
                    },
                ]),
                    t
    ...
    function Gr(t) {
        var e,
            ...
            r = "",
            i = t.length;
        for (e = 0; e < i; e++) (n = t.charCodeAt(e)), Math.random() > 0.5 && (n = "x" + n.toString(16)), (r += "&#" + n + ";");
        return r;
    }
    var Xr = (function () {
            function t(e) {
                ...
                this.options.pedantic ? ((n.block = Br.pedantic), (n.inline = Yr.pedantic)) : this.options.gfm && ((n.block = Br.gfm), this.options.breaks ? (n.inline = Yr.breaks) : (n.inline = Yr.gfm)), (this.tokenizer.rules = n);
            }
            return (
                fe(
                    t,
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                ...
                                for (t = t.replace(/^ +$/gm, ""); t; )
                                    ...
                                    else if ((e = this.tokenizer.code(t, a))) (t = t.substring(e.raw.length)), e.type ? a.push(e) : (((i = a[a.length - 1]).raw += "\n" + e.raw), (i.text += "\n" + e.text));
                                    ...
                                    else if ((e = this.tokenizer.blockquote(t))) (t = t.substring(e.raw.length)), (e.tokens = this.blockTokens(e.text, [], o)), a.push(e);
                                    else if ((e = this.tokenizer.list(t))) {
                                        for (t = t.substring(e.raw.length), r = e.items.length, n = 0; n < r; n++) e.items[n].tokens = this.blockTokens(e.items[n].text, [], !1);
                                        a.push(e);
                                    } else if ((e = this.tokenizer.html(t))) (t = t.substring(e.raw.length)), a.push(e);
                                    else if (o && (e = this.tokenizer.def(t))) (t = t.substring(e.raw.length)), this.tokens.links[e.tag] || (this.tokens.links[e.tag] = { href: e.href, title: e.title });
                                    ...
                                    else if ((e = this.tokenizer.text(t, a))) (t = t.substring(e.raw.length)), e.type ? a.push(e) : (((i = a[a.length - 1]).raw += "\n" + e.raw), (i.text += "\n" + e.text));
                                    else if (t) {
                                ...
                                for (e = 0; e < l; e++)
                                    switch ((o = t[e]).type) {
                                        ...
                                        case "heading":
                                            ...
                                            break;
                                        case "table":
                                            for (o.tokens = { header: [], cells: [] }, i = o.header.length, n = 0; n < i; n++) (o.tokens.header[n] = []), this.inlineTokens(o.header[n], o.tokens.header[n]);
                                            for (i = o.cells.length, n = 0; n < i; n++) for (a = o.cells[n], o.tokens.cells[n] = [], r = 0; r < a.length; r++) (o.tokens.cells[n][r] = []), this.inlineTokens(a[r], o.tokens.cells[n][r]);
                                            break;
                                        case "blockquote":
                        ...
                        },
                        {
                            ...
                            value: function (t) {
                                for (
                                    ...
                                    else if ((e = this.tokenizer.tag(t, r, i))) (t = t.substring(e.raw.length)), (r = e.inLink), (i = e.inRawBlock), n.push(e);
                                    else if ((e = this.tokenizer.link(t))) (t = t.substring(e.raw.length)), "link" === e.type && (e.tokens = this.inlineTokens(e.text, [], !0, i)), n.push(e);
                                    else if ((e = this.tokenizer.reflink(t, this.tokens.links))) (t = t.substring(e.raw.length)), "link" === e.type && (e.tokens = this.inlineTokens(e.text, [], !0, i)), n.push(e);
                                    else if ((e = this.tokenizer.strong(t))) (t = t.substring(e.raw.length)), (e.tokens = this.inlineTokens(e.text, [], r, i)), n.push(e);
                                    else if ((e = this.tokenizer.em(t))) (t = t.substring(e.raw.length)), (e.tokens = this.inlineTokens(e.text, [], r, i)), n.push(e);
                                    ...
                                    else if ((e = this.tokenizer.del(t))) (t = t.substring(e.raw.length)), (e.tokens = this.inlineTokens(e.text, [], r, i)), n.push(e);
                ...
                fe(t, [
                    {
                        ...
                        value: function (t, e, n) {
                            ...
                            return r ? '<pre><code class="' + this.options.langPrefix + ei(r, !0) + '">' + (n ? t : ei(t, !0)) + "</code></pre>\n" : "<pre><code>" + (n ? t : ei(t, !0)) + "</code></pre>\n";
                        },
                    },
                    {
                        key: "blockquote",
                                ...
                                for (e = 0; e < w; e++)
                                    switch ((u = t[e]).type) {
                                        ...
                                        case "hr":
                                            ...
                                            continue;
                                        case "heading":
                                            b += this.renderer.heading(this.parseInline(u.tokens), u.depth, oi(this.parseInline(u.tokens, this.textRenderer)), this.slugger);
                                            continue;
                                        case "code":
                                            b += this.renderer.code(u.text, u.lang, u.escaped);
                                            continue;
                                        case "table":
                                            for (s = "", l = "", i = u.header.length, n = 0; n < i; n++) l += this.renderer.tablecell(this.parseInline(u.tokens.header[n]), { header: !0, align: u.align[n] });
                                            for (s += this.renderer.tablerow(l), c = "", i = u.cells.length, n = 0; n < i; n++) {
                                                for (l = "", a = (o = u.tokens.cells[n]).length, r = 0; r < a; r++) l += this.renderer.tablecell(this.parseInline(o[r]), { header: !1, align: u.align[r] });
                                            ...
                                            for (p = u.ordered, d = u.start, f = u.loose, i = u.items.length, c = "", n = 0; n < i; n++)
                                                ...
                                                ((y = this.renderer.checkbox(m)),
                                                    f
                                                        ...
                                                        g.tokens[0].tokens && g.tokens[0].tokens.length > 0 && "text" === g.tokens[0].tokens[0].type && (g.tokens[0].tokens[0].text = y + " " + g.tokens[0].tokens[0].text))
                                        ...
                                        case "paragraph":
                                            ...
                                            continue;
                                        case "text":
                                            for (c = u.tokens ? this.parseInline(u.tokens) : u.text; e + 1 < w && "text" === t[e + 1].type; ) c += "\n" + ((u = t[++e]).tokens ? this.parseInline(u.tokens) : u.text);
    ...
    function hi(t, e, n) {
        ...
        try {
            ...
            if (((t.message += "\nPlease report this to https://github.com/markedjs/marked."), e.silent)) return "<p>An error occurred:</p><pre>" + ui(t.message + "", !0) + "</pre>";
            throw t;
        }
    }
    (hi.options = hi.setOptions = function (t) {
        ...
        (hi.use = function (t) {
            ...
            if (
                ...
                t.tokenizer &&
                (function () {
                    var n = hi.defaults.tokenizer || new Dr(),
                        r = function (e) {
                            var r = n[e];
                            n[e] = function () {
                                for (var i = arguments.length, a = new Array(i), o = 0; o < i; o++) a[o] = arguments[o];
        ...
        function n() {
                ...
                ? (((e = window.open("about:blank", "reveal.js - Notes", "width=1100,height=700")).marked = gi),
                    ...
                    e
                        ? ((n = setInterval(function () {
                            e.postMessage(
                                JSON.stringify({ namespace: "reveal-notes", type: "connect", url: window.location.protocol + "//" + window.location.host + window.location.pathname + window.location.search, state: t.getState() }),
                                "*"
                            );
                        }, 500)),
                            window.addEventListener("message", function (i) {
                                ...
                                "connected" === c.type &&
                                (clearInterval(n), t.on("slidechanged", r), t.on("fragmentshown", r), t.on("fragmenthidden", r), t.on("overviewhidden", r), t.on("overviewshown", r), t.on("paused", r), t.on("resumed", r), r()),
                                c &&
                                "reveal-notes" === c.namespace &&
                                "call" === c.type &&
                                ((a = c.methodName), (o = c.arguments), (l = c.callId), (s = t[a].apply(t, o)), e.postMessage(JSON.stringify({ namespace: "reveal-notes", type: "return", result: s, callId: l }), "*"));
                            }))
            ...
            function r(n) {
                var r = t.getCurrentSlide(),
                    ...
                    o = { namespace: "reveal-notes", type: "state", notes: "", markdown: !1, whitespace: "normal", state: t.getState() };
                if ((r.hasAttribute("data-notes") && ((o.notes = r.getAttribute("data-notes")), (o.whitespace = "pre-wrap")), a)) {
                    var l = a.querySelector("aside.notes");
                    l ? (i = l) : a.hasAttribute("data-notes") && ((o.notes = a.getAttribute("data-notes")), (o.whitespace = "pre-wrap"), (i = null));
                }
                i && ((o.notes = i.innerHTML), (o.markdown = "string" == typeof i.getAttribute("data-markdown"))), e.postMessage(JSON.stringify(o), "*");
            }
        }
        return {
            id: "notes",
